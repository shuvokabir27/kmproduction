...
const MemberDashboard = () => {
  ...
  const balanceCards = [
    ...
    { label: "বাইরের আয়", value: balance?.totalFreelance, icon: Briefcase, gradient: "from-orange-500/20 to-orange-500/5", iconColor: "text-orange-400", iconBg: "bg-orange-500/10", onClick: () => setFreelanceDetailOpen(true) },
  ];
