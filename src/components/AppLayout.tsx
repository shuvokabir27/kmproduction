...
export function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <SidebarProvider defaultOpen={!isMobile}>
      <div className="h-screen flex w-full bg-background noise-bg overflow-hiddenrflow-hidden">
        {/* Desktop sidebar — hidden on mobile */}
        <div className="hidden md:block">
          <AppSidebar />
        </div>

        <div className="flex-1 flex flex-col min-overflow-hiddn-h-0 h-screen">
          {/* Top header */}
