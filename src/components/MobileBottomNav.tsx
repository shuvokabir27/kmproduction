...
const permissionIconMap: Record<string, { icon: any; color: string; bg: string }> = {
  shooting_expenses: { icon: Receipt, color: "text-amber-600", bg: "bg-amber-100" },
  shootings: { icon: Film, color: "text-rose-600", bg: "bg-rose-100" },
  attendance: { icon: Calendar, color: "text-emerald-600", bg: "bg-emerald-100" },
};
...
const moreItems = [
  ...
  { icon: Users, label: "সদস্য", path: "/admin/members", color: "text-blue-600", bg: "bg-blue-100" },
  { icon: FileText, label: "স্ক্রিপ্ট", path: "/admin/scripts", color: "text-indigo-600", bg: "bg-indigo-100" },
  { icon: Mic, label: "ভয়েস নোট", path: "/admin/voice-notes", color: "text-pink-600", bg: "bg-pink-100" },
  { icon: ListTodo, label: "টাস্ক", path: "/tasks", color: "text-emerald-600", bg: "bg-emerald-100" },
  { icon: Receipt, label: "শুটিং খরচ", path: "/admin/shooting-expenses", color: "text-amber-600", bg: "bg-amber-100" },
  { icon: Briefcase, label: "বাইরের কাজ", path: "/admin/freelance", color: "text-orange-600", bg: "bg-orange-100" },
  { icon: Megaphone, label: "নোটিশ", path: "/admin/notices", color: "text-red-600", bg: "bg-red-100" },
  { icon: MessageCircle, label: "চ্যাট", path: "/chat", color: "text-sky-600", bg: "bg-sky-100" },
  { icon: ShieldCheck, label: "রোল ম্যানেজমেন্ট", path: "/admin/role-management", color: "text-violet-600", bg: "bg-violet-100" },
  { icon: ShieldCheck, label: "ফিচার টগল", path: "/admin/feature-toggles", color: "text-purple-600", bg: "bg-purple-100" },
  { icon: Smartphone, label: "অ্যাপ ভার্সন", path: "/admin/app-versions", color: "text-teal-600", bg: "bg-teal-100" },
  { icon: null, label: "— একাউন্ট ও পেমেন্ট —", path: "__divider_acc__", color: "", bg: "" },
  { icon: Wallet, label: "বেতন আপডেট", path: "/admin/salary-updates", color: "text-emerald-600", bg: "bg-emerald-100" },
  { icon: Gift, label: "বোনাস", path: "/admin/bonuses", color: "text-rose-600", bg: "bg-rose-100" },
  { icon: Calculator, label: "একাউন্ট চেকিং", path: "/admin/account-checking", color: "text-cyan-600", bg: "bg-cyan-100" },
  { icon: null, label: "— পাবলিক সাইট —", path: "__divider2__", color: "", bg: "" },
  { icon: Home, label: "সাইট দেখুন", path: "/", color: "text-blue-600", bg: "bg-blue-100" },
  { icon: Globe, label: "পাবলিক প্রোফাইল", path: "/admin/public-profiles", color: "text-sky-600", bg: "bg-sky-100" },
  { icon: Film, label: "অভিনেতা পোর্টফোলিও", path: "/admin/actor-editor", color: "text-fuchsia-600", bg: "bg-fuchsia-100" },
  { icon: Newspaper, label: "নিউজ", path: "/admin/news", color: "text-stone-700", bg: "bg-stone-100" },
  { icon: Sparkles, label: "সেবা / প্যাকেজ", path: "/admin/services", color: "text-amber-600", bg: "bg-amber-100" },
  { icon: ClipboardList, label: "বুকিং", path: "/admin/bookings", color: "text-indigo-600", bg: "bg-indigo-100" },
  { icon: Tv, label: "চ্যানেল", path: "/admin/channels", color: "text-purple-600", bg: "bg-purple-100" },
  { icon: Play, label: "জনপ্রিয় কাজ", path: "/admin/popular-videos", color: "text-red-600", bg: "bg-red-100" },
  { icon: ImageIcon, label: "ছবি গ্যালারী", path: "/admin/gallery", color: "text-pink-600", bg: "bg-pink-100" },
  { icon: Phone, label: "যোগাযোগ সেটিংস", path: "/admin/contact-settings", color: "text-emerald-600", bg: "bg-emerald-100" },
  { icon: null, label: "— অন্যান্য —", path: "__divider3__", color: "", bg: "" },
  { icon: Settings, label: "সেটিংস", path: "/admin/settings", color: "text-slate-600", bg: "bg-slate-100" },
