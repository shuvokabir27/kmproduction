...
AS $function$
  SELECT p.id, p.member_id, p.full_name, p.full_name_en, p.photo_url, p.cover_url,
         ...
         p.favorite_food, p.favorite_food_en, p.date_of_birth, p.blood_group,
         p.address, p.address_en,
         p.is_verified, p.is_active, p.show_on_public, p.public_display_order, p.joining_date
